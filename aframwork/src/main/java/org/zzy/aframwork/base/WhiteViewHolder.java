...
public class WhiteViewHolder {
    ...
    public WhiteViewHolder setOnClickListener(int viewId, View.OnClickListener listener) {
        View view = getView(viewId);
        view.setOnClickListener(listener);
        return this;
    }
    public WhiteViewHolder setOnFocusChangeListener(int viewId, View.OnFocusChangeListener listener) {
        View view = getView(viewId);
        view.setOnFocusChangeListener(listener);
        return this;
    }
    public WhiteViewHolder setOnFocusChangeListenerWithTag(int viewId, View.OnFocusChangeListener listener, Object tag) {
        View view = getView(viewId);
        view.setOnFocusChangeListener(listener);
        view.setTag(tag);
        return this;
